...
4. **Paragraph rhythm.** Count words per paragraph and compare the distribution to the register the piece should be in. Flag the two failure modes explicitly: a wall of one-line paragraphs stacked like verse, and uniform blocks with no short lines at all.
5. **The burst.** Does a run of three or four sentences under 12 words appear every few paragraphs? Its absence makes a text technically correct and tonally dead.
6. **Headings.** Right grammatical form? Any question-headings? Any numbering?
7. **Sentence openings.** Are there And / But / Because starts? Any deliberate fragments? Their total absence is a strong tell.
...
13. **Lexicon and anti-tells.** Scan for the forbidden list in the relevant lexicon, and for the positive habits it records — connectors, sentence openings, favourite constructions. Quote every hit in both directions.
